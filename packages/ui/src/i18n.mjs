...
const translations = {
  fr: {
    ...
    "menu_item.simulation.perception_run": "Lancer la perception",
    "menu_item.simulation.integration_replay": "Rejouer une liaison degradee",
    "menu_item.simulation.commissioning_session": "Demarrer le commissioning",
    "menu_item.simulation.as_built_compare": "Comparer l as-built",
    "menu_item.simulation.optimization_run": "Lancer l optimisation",
    ...
    "ui.workspace.openspec_section": "OpenSpec",
    "ui.workspace.no_openspec": "Aucun document OpenSpec",
  ...
  en: {
    ...
    "menu_item.simulation.perception_run": "Run Perception",
    "menu_item.simulation.integration_replay": "Replay Degraded Link",
    "menu_item.simulation.commissioning_session": "Start Commissioning",
    "menu_item.simulation.as_built_compare": "Compare As-Built",
    "menu_item.simulation.optimization_run": "Run Optimization",
    ...
    "ui.ai.profile_label": "AI Profile",
    "ui.ai.profile_hint":
      "The selected profile controls the depth of the local runtime on the next message.",
    "menu_item.git.commit": "Commit",
    "menu_item.git.push": "Push",
    "menu_item.git.pull": "Pull",
    "menu_item.git.branch": "Branches",
    ...
    "ui.workspace.plugins_section": "Plugins",
    "ui.workspace.openspec_section": "OpenSpec",
    "ui.workspace.no_openspec": "No OpenSpec documents",
  ...
  es: {
    ...
    "menu_item.simulation.perception_run": "Ejecutar percepcion",
    "menu_item.simulation.integration_replay": "Reproducir enlace degradado",
    "menu_item.simulation.commissioning_session": "Iniciar commissioning",
    "menu_item.simulation.as_built_compare": "Comparar as-built",
    "menu_item.simulation.optimization_run": "Ejecutar optimizacion",
    ...
    "ui.ai.profile_label": "Perfil IA",
    "ui.ai.profile_hint":
      "El perfil seleccionado controla la profundidad del runtime local en el proximo mensaje.",
    "menu_item.git.commit": "Commit",
    "menu_item.git.push": "Push",
    "menu_item.git.pull": "Pull",
    ...
    "ui.workspace.plugins_section": "Plugins",
    "ui.workspace.openspec_section": "OpenSpec",
    "ui.workspace.no_openspec": "Sin documentos OpenSpec",
